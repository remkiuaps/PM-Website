...
const translations = {
  pl: {
    ...
    "products.2.desc": "Praktyczny materiał do pakowania, przekładania i zabezpieczania towaru podczas transportu oraz magazynowania. Tektura falista skutecznie chroni produkty przed zarysowaniami, otarciami i drobnymi uszkodzeniami mechanicznymi.\n\nDoskonale sprawdza się przy zabezpieczaniu mebli, elementów szklanych, ceramiki, części, paczek oraz innych produktów wymagających dodatkowej ochrony. To wygodne i ekonomiczne rozwiązanie dla magazynów, firm wysyłkowych, sklepów internetowych i branży produkcyjnej.",
    "products.3.title": "Papier nacinany honeycomb",
    "products.3.desc": "Papier nacinany honeycomb kraft w rolkach to nowoczesny i wytrzymały papier do pakowania oraz zabezpieczania delikatnych produktów w transporcie i wysyłce. Dzięki strukturze plastra miodu doskonale sprawdza się jako papier zabezpieczający do szkła, porcelany, ceramiki, kosmetyków, świec, produktów dekoracyjnych i innych kruchych towarów. Skutecznie chroni przed stłuczeniem, zarysowaniem i uszkodzeniem, a jednocześnie przyspiesza codzienne pakowanie przesyłek.\n\nOferujemy papier honeycomb kraft 70 i 80 g/m² w rolkach o szerokości 20, 30, 40 i 50 cm oraz długości 25, 50, 100 i 250 m. To praktyczne rozwiązanie dla sklepów internetowych, firm wysyłkowych, pracowni handmade, drogerii, sklepów z ceramiką oraz sprzedawców produktów delikatnych.",
    "products.4.title": "Papier bąbelkowy",
    "products.4.desc": "Papierowa alternatywa dla folii bąbelkowej, przeznaczona do pakowania i zabezpieczania delikatnych produktów w transporcie, magazynowaniu i podczas przygotowania wysyłek. Dzięki swojej tłoczonej strukturze skutecznie chroni przed zarysowaniami, otarciami i uszkodzeniami mechanicznymi, zapewniając produktom bezpieczne dotarcie do odbiorcy.\n\nDoskonale sprawdza się przy pakowaniu szkła, ceramiki, porcelany, kosmetyków, świec, dekoracji i innych kruchych towarów. To rozwiązanie chętnie wybierane przez sklepy internetowe, firmy wysyłkowe, pracownie rękodzielnicze oraz branżę dekoracyjną. W 100% papierowy, w pełni biodegradowalny, a po użyciu nadaje się do recyklingu — ekologiczna i odpowiedzialna ochrona produktów.",
    ...
    "contact.form.placeholder.phone": "+48 532 104 492",
    ...
    "contact.info.phone": "+48 532 104 492",
    "contact.info.email": "info@packingmaster.com",
    "contact.info.address": "Korczunkowa 20\n05-503 Głosków",
